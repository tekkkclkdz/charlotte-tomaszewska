...
const NavBar = ({ stillOrMoving, intro }:{
  ...
  return (
    <>
      ...
      <div className={`py-2 w-full mix-blend-difference text-lg sm:text-lg md:text-lg lg:text-2xl ml-[1.3rem] bg-transparent transition-opacity duration-300 ${intro === 1 ? 'absolute top-0' : 'sticky top-0'}`} suppressHydrationWarning={true}>
