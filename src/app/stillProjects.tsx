...
export const projects = [
    {
      id: 1, title: 'DOCUMENT JOURNAL', content: (
          <div className="flex">
  ...
  <div>
    ...
    { id: 3, title: 'MOON SHADOW', content: (
    ...
    { id: 5, title: 'JAN_F_CHODOROWICZ', content: (
        <div>
        <div className="w-screen">
    ...
    { id: 6, title: 'REST IS DUST', content: (
      <div className='flex flex-wrap '>
