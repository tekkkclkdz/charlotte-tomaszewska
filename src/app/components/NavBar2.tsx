...
const NavBar = ({ stillOrMoving, intro }:{
  ...
  return (
    <>
      ...
      <div className={`py-2 w-full mix-blend-difference text-lg sm:text-3xl sm:ml-[1.6rem] bg-transparent transition-opacity duration-300 ${intro === 1 ? 'absolute top-0' : 'sticky top-0'}`} suppressHydrationWarning={true}>
