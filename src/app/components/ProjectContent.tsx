    ...
    <div className="bg-white">
      ...
      <div className="fixed bottom-0 left-0 right-0 mix-blend-difference shadow-md text-center transition-opacity duration-300 ease-in-out">
        ...
        {activeProject !== null && !isAtBottom ? (
          <h2
            className={`relative text-lg sm:text-2xl mb-[7px] sm:mb-2 font-customMedium mix-blend-difference text-black dark:text-white opacity-100 transition-opacity duration-300`}
          >
